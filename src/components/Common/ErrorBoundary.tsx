          ...
          <div className="max-w-3xl w-full bg-slate-900 border border-red-500/50 rounded-xl p-6 space-y-5 shadow-2xl">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-md text-xs font-bold flex items-center gap-2 shadow-xs transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 rounded-md text-xs font-bold flex items-center gap-2 transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="px-3 py-2 bg-slate-950 hover:bg-slate-800 text-slate-400 border border-slate-800 rounded-md text-xs font-bold flex items-center gap-1.5 ml-auto transition-colors cursor-pointer"
              >
