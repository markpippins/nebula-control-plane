...
export const SidebarNav: React.FC = () => {
  ...
  return (
    <aside className="w-56 bg-slate-200 dark:bg-slate-950 border-r border-slate-300 dark:border-slate-800/80 flex flex-col justify-between shrink-0 select-none z-20 font-sans shadow-xs">
          ...
          return (
            <button
              ...
              className={`w-full flex items-center justify-between px-2.5 py-2 rounded text-xs font-medium transition-all group ${
                isActive
                  ? 'bg-sky-600 dark:bg-indigo-600 text-white shadow-sm font-semibold'
                  : 'text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-300/80 dark:hover:bg-slate-900/80'
              }`}
            >
                ...
                <span
                  className={`px-1.5 py-0.2 rounded-full text-[10px] font-mono font-bold ${
                    isActive
                      ...
                      : item.badgeColor || 'bg-slate-300 dark:bg-slate-800 text-slate-800 dark:text-slate-300'
                  }`}
                >
                  {item.badge}
                </span>
      ...
      <div className="p-2.5 border-t border-slate-300 dark:border-slate-800/80 bg-slate-300/50 dark:bg-slate-950/60 font-mono text-[11px] text-slate-600 dark:text-slate-400 space-y-1.5">
        <div className="flex items-center justify-between">
          <span className="flex items-center gap-1.5 text-xs">
            <Activity className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
            <span className="font-semibold text-slate-800 dark:text-slate-200">nebula-srv v2.4</span>
          </span>
          <span className="text-[10px] bg-slate-200 dark:bg-slate-800 px-1.5 py-0.5 rounded text-emerald-700 dark:text-emerald-400 border border-slate-300 dark:border-slate-700 font-bold">
            PORT 3101
          </span>
        </div>
