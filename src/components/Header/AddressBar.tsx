    ...
    <header className="h-12 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800/80 px-3 flex items-center justify-between text-xs font-mono select-none text-slate-800 dark:text-slate-200 shrink-0 z-30 shadow-2xs">
      ...
      <div className="flex items-center gap-3">
        <div
          ...
          className="flex items-center gap-2 px-2.5 py-1 bg-sky-50 dark:bg-indigo-950/80 border border-sky-200 dark:border-indigo-500/60 rounded text-sky-900 dark:text-indigo-300 hover:bg-sky-100 dark:hover:bg-indigo-900/90 cursor-pointer transition-all tracking-wider font-semibold shadow-2xs"
        ...
        {/* Breadcrumb Path */}
        <div className="hidden md:flex items-center gap-1.5 text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-900/60 px-2.5 py-1 rounded border border-slate-200 dark:border-slate-700/50">
      ...
      <div className="flex items-center gap-2">
        ...
        <div
          className={`flex items-center gap-1.5 px-2 py-0.5 rounded text-[11px] font-medium border ${
            wsConnected
              ? 'bg-emerald-50 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-400 border-emerald-300 dark:border-emerald-800/50'
              : 'bg-amber-50 dark:bg-amber-950/60 text-amber-800 dark:text-amber-400 border-amber-300 dark:border-amber-800/50'
          }`}
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-2 py-0.5 rounded text-[11px] font-medium border transition-colors ${
            apiConfig.useMock
              ? 'bg-sky-50 dark:bg-blue-950/60 text-sky-900 dark:text-blue-300 border-sky-300 dark:border-blue-800/50 hover:bg-sky-100 dark:hover:bg-blue-900/60'
              : 'bg-purple-50 dark:bg-purple-950/60 text-purple-900 dark:text-purple-300 border-purple-300 dark:border-purple-800/50 hover:bg-purple-100 dark:hover:bg-purple-900/60'
          }`}
        ...
        {/* 3-Mode Color Scheme Selector (Light, Dark, Steel) */}
        <div className="flex items-center bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded p-0.5 font-mono text-[10px] shadow-2xs">
          <button
            ...
            title="Switch to Light Color Scheme"
          >
            <Sun className="w-3 h-3 text-amber-700 dark:text-amber-400" />
          ...
          <button
            ...
            title="Switch to Dark Color Scheme"
          >
          ...
          <button
            ...
            title="Switch to Industrial Steel Color Scheme"
          >
            <Shield className="w-3 h-3 text-sky-900 dark:text-sky-300" />
